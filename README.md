...
DHT22 sensor using an ESP32 microcontroller to send data towards a python script that utilizes a anthropic agent to run basic commands such as monitoring the temperature, and turning on a mini fan blade hooked up to a 130 DC motor. 
